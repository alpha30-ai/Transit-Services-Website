...
const productsData = [
    ...
    function getProductContainer(service) {
        switch(service) {
            case 'pharmacy': return pharmacyProducts;
            case 'hypermarket': return hypermarketProducts;
            case 'restaurant': return restaurantProducts;
            case 'car-service': return carServiceProducts;
            default: return null;
        }
    }
